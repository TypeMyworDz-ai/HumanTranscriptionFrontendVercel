// frontend/client/src/routes/AppRoutes.js
...
// NEW: Import UserChat component
import UserChat from '../UserChat.js';
// NEW: Import AdminMessageList component
import AdminMessageList from '../AdminMessageList.js'; // FIX: Corrected import
    ...
    return (
        <Routes>
            ...
            <Route element={<ProtectedRoute />}>
                ...
                {/* NEW: User Chat Route for clients */}
                ...
                {/* NEW: User Chat Route for transcribers */}
                ...
                {/* Admin Chat Routes */}
                <Route path="/admin/chat" element={<AdminMessageList />} /> {/* NEW: Route to the chat list */}
                <Route path="/admin/chat/:userId" element={<AdminChat />} /> {/* Existing route for individual chat */}
